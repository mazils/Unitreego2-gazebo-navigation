...
setup(
    ...
    data_files=[
        ...
        ('share/ament_index/resource_index/packages', ['resource/front_obstacle_detector']),
    ('share/front_obstacle_detector', ['package.xml']),
    ('share/front_obstacle_detector/launch', ['launch/obstacles_and_motion.launch.py']),
    ],
